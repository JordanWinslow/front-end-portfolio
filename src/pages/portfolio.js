...
/* THIS IS JUST FOR FUN CONSOLE LOG STYLING */
const css =
...
console.log(`Portfolio page utilizing intersection observer to only display certain content when it is in the viewport as
well as lazy loading to only load content when it enters the viewport.
