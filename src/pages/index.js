...
const IndexPage = () => {
  ...
  return (
    <Layout>
      <SEO title="Home" />
      <div id="HeaderText" style={{ marginBottom: "3rem" }}>
        <center>
      ...
      <div>
        BOOM. Dark mode toggle implemented. Now you can click the lightbulb to
        switch color schemes along with a fading animation.
        <br />
        <br />
